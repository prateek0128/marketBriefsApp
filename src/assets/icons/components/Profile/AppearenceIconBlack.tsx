...
const SvgAppearenceIconBlack = (props) => (
  <Svg
  ...
  >
    ...
    <G mask="url(#appearenceIconBlack_svg__a)">
      <Path
        stroke="#303437"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceIconBlack_svg__b)">
      <Path
        stroke="#303437"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceIconBlack_svg__c)">
      <Path
        stroke="#303437"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceIconBlack_svg__d)">
      <Path
        stroke="#303437"
        strokeWidth={1.5}
...
export default SvgAppearenceIconBlack;
