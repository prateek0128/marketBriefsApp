...
const SvgAppearenceDarkIcon = (props) => (
  <Svg
  ...
  >
    ...
    <G mask="url(#appearenceDarkIcon_svg__a)">
      <Path
        stroke="#E3E5E6"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceDarkIcon_svg__b)">
      <Path
        stroke="#E3E5E6"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceDarkIcon_svg__c)">
      <Path
        stroke="#E3E5E6"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceDarkIcon_svg__d)">
      <Path
        stroke="#E3E5E6"
        strokeWidth={1.5}
...
export default SvgAppearenceDarkIcon;
