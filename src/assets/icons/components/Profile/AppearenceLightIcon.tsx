...
const SvgAppearenceLightIcon = (props) => (
  <Svg
  ...
  >
    ...
    <G mask="url(#appearenceLightIcon_svg__a)">
      <Path
        stroke="#303437"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceLightIcon_svg__b)">
      <Path
        stroke="#303437"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceLightIcon_svg__c)">
      <Path
        stroke="#303437"
        strokeWidth={1.5}
    ...
    <G mask="url(#appearenceLightIcon_svg__d)">
      <Path
        stroke="#303437"
        strokeWidth={1.5}
...
export default SvgAppearenceLightIcon;
