  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => {
        ...
        // Hide tabBar for specific inner screens
        const showTabBarScreens = ["Home", "Saved", "Interests", "Profile"];
        const isTabBarVisible = showTabBarScreens.includes(routeName ?? "");
        return {
          headerShown: false,
          tabBarStyle: {
            display: isTabBarVisible ? "flex" : "none", // Hide tabBar
            backgroundColor:
          ...
          // },
          sceneContainerStyle: {
            backgroundColor: "#FBFFF1", // Covers under tabBar
          },
        };
      }}
    >
